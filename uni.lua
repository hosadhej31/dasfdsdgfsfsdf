local utility = loadstring(game:HttpGet('https://raw.githubusercontent.com/hosadhej31/dasfdsdgfsfsdf/main/lib.lua', true))()

local tween = loadstring(game:HttpGet("https://raw.githubusercontent.com/hosadhej31/dasfdsdgfsfsdf/main/custom.lua"))()
